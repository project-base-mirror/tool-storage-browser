...
发布状态（2026-07-28）：v0.6.0 已完成正式发布准备；Release 与 Pages 由不可变 `v0.6.0` tag 自动构建和部署。
...
开发状态（2026-07-28）：版本分页、指定版本下载/恢复/删除、Delete Marker 清理、普通删除提示与 CLI 已完成，等待发布准备和 Provider 实机矩阵确认。
