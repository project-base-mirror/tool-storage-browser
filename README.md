...
脚本默认执行 restore、全量测试和 Release 构建，然后生成：
    ...
    artifacts/release/S3Explorer-v0.7.3-win-x64.zip
    artifacts/release/S3Explorer-v0.7.3-win-x64-self-contained.zip
    artifacts/release/S3Explorer.Contracts-v0.7.3.zip
    artifacts/release/S3Explorer-v0.7.3-win-x64-setup.msi
    artifacts/release/S3Explorer-v0.7.3-win-x64-framework-dependent-setup.msi
